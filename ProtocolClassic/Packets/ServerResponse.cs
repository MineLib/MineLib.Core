...
using ProtocolClassic.Packets.Extension.Client;
using ProtocolClassic.Packets.Extension.Server;
using ProtocolClassic.Packets.Server;

namespace ProtocolClassic.Packets
{
    public static class ServerResponseClassic
    {
        ...
        {
            () => new ServerIdentificationPacket(),             // 0x00
            () => new PingPacket(),                             // 0x01
            () => new LevelInitializePacket(),                  // 0x02
            () => new LevelDataChunkPacket(),                   // 0x03
            () => new LevelFinalizePacket(),                    // 0x04
            null,                                               // 0x05
            () => new SetBlockPacket(),                         // 0x06
            () => new SpawnPlayerPacket(),                      // 0x07
            () => new PositionAndOrientationTeleportPacket(),   // 0x08
            () => new PositionAndOrientationUpdatePacket(),     // 0x09
            () => new PositionUpdatePacket(),                   // 0x0A
            () => new OrientationUpdatePacket(),                // 0x0B
